...
export default function FreshHero({ onExplore, onAccount }: { onExplore: () => void; onAccount: () => void }) {
  return <section className="fresh-hero" aria-label="Fresh produce promotion">
    ...
    <button type="button" aria-label="Account" className="fresh-profile" onClick={onAccount}><User size={20}/></button>
